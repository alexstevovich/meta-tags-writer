...
export class OpenGraphMetaTags {
    constructor() {
        this.useNewLineBetweenEntries = Config.useNewLineBetweenEntries;
...
export default  { CommonMetaTags, SEOMetaTags, OpenGraphMetaTags, TwitterMetaTags, PageMetaTags, Config };
